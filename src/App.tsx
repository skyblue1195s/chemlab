...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-100 flex flex-col font-sans selection:bg-cyan-500 selection:text-black">
      ...
      <header className="sticky top-0 z-40 bg-[#020617]/85 backdrop-blur-md border-b border-slate-800/50 px-4 lg:px-8 py-3.5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            <div className="flex flex-col items-end">
              ...
              <div className="w-28 sm:w-32 h-1 bg-slate-800 rounded-full overflow-hidden mt-1">
                <div
                  className="h-full bg-cyan-400 shadow-[0_0_8px_rgba(34,211,238,0.6)] transition-all duration-500"
            ...
            {/* Streak Flame Pill */}
            <div className="flex items-center gap-2 bg-orange-500/10 border border-orange-500/20 px-3 py-1 rounded-full text-xs font-bold text-orange-400">
              <span className="text-orange-400">🔥</span>
              <span className="font-mono">{userStats.streakDays}</span>
              <span className="text-orange-400/80 text-[11px] font-medium hidden sm:inline">ngày streak</span>
            </div>
            ...
            {!currentUser ? (
              <button
                ...
                className="px-3.5 py-1.5 rounded-full bg-gradient-to-r from-amber-400 via-amber-500 to-yellow-400 hover:from-amber-300 hover:to-yellow-300 text-slate-950 font-bold text-xs flex items-center gap-2 shadow-[0_0_15px_rgba(251,191,36,0.4)] transition-all animate-pulse"
              ...
              <button
                ...
                onClick={() => setIsAuthModalOpen(true)}
                className="flex items-center gap-2 p-1 pl-1.5 pr-3 rounded-full bg-slate-900 border border-emerald-500/40 hover:border-emerald-400 transition-all text-xs group"
              ...
              >
                {currentUser.photoURL ? (
                  <img
                    ...
                    className="w-7 h-7 rounded-full object-cover border border-emerald-400 shadow-[0_0_8px_rgba(16,185,129,0.4)]"
                ...
                <div className="flex flex-col items-start leading-tight">
                  <span className="font-bold text-white max-w-[85px] truncate text-[11px] group-hover:text-emerald-300 transition-colors">
            ...
            {/* Grade Switcher */}
            <div className="flex items-center gap-1 p-1 bg-slate-900/90 rounded-full border border-slate-800 text-xs">
